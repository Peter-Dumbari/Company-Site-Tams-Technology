...
import "../AnimatedCard/Animatecard.scss";
...
function Animatedcard({
  ...
  return (
    <div className="animatedcard_container">
      <div className="image_container">
        <Link className="link_classname" to={`${link}/${id}`}>
          <img src={cardimage} alt="cardimage" className="cardimage" />
        </Link>
        <div
          className="view_container d-flex "
          onClick={() => addtochart(item)(authDispatch)}>
          <span className="items">
            ...
            <span className="text">{false ? "View Cart" : "Add to Cart"}</span>
          </span>
        </div>
        <div className="icon_container d-flex flex-column flex-wrap">
          <button>
            <svg
              width="18"
              height="18"
          ...
          <button>
            ...
            <span className="product-action-tooltip">Product Detail</span>
          </button>
        </div>
      </div>
      <h3>{cardname}</h3>
      <div className="price_container d-flex">
        {sale && <del className="oldprice">{oldprice}</del>}
        <span className="newprice">${newprice}</span>
      </div>
      {sale && (
        <div className="sale_container flex-wrap">
          <div className="sale_box">
            <span>Sale</span>
          </div>
          <div className="discount_box">
            <span>-{carddiscount}</span>
          </div>
        </div>
      )}
    </div>
